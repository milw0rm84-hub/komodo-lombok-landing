    ...
    >
      ...
      <header className="relative h-[100vh] flex items-center px-6 md:px-24 overflow-hidden border-b border-[#C19B6E]/10">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#042D20]/80 via-[#042D20]/40 to-transparent"></div>
        </div>

        <div className="relative z-10 max-w-2xl">
          <span className="text-[#C19B6E] text-[9px] md:text-[10px] tracking-[0.8em] uppercase block mb-6 font-bold hero-reveal">Private Expeditions</span>
          <h1 className="font-serif italic text-white text-4xl md:text-7xl leading-[0.95] mb-6 hero-reveal">
            Where Silence <br />
            <span className="text-[#C19B6E]">Meets the Sea</span>
          </h1>
          <p className="text-white/60 text-base md:text-lg italic leading-relaxed mb-10 max-w-md hero-reveal">
            Exclusive passages through the Komodo archipelago and beyond. Your private vessel, your pace, your story.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 hero-reveal">
            <a href={waLink} className="bg-[#C19B6E] text-[#042D20] px-10 py-4 text-[9px] tracking-[0.4em] uppercase font-bold rounded-full text-center hover:bg-[#e6ccab] transition-all duration-500">
              Begin Your Journey
            </a>
            <a href="#itinerary" className="border border-white/20 text-white px-10 py-4 text-[9px] tracking-[0.4em] uppercase font-bold rounded-full text-center hover:border-[#C19B6E] hover:text-[#C19B6E] transition-all duration-500">
              Explore Routes
            </a>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="reveal group bg-[#021811] border border-white/5 rounded-sm overflow-hidden">
              ...
              <div className="p-8 md:p-10">
                ...
                <a href="https://lombokperfect.com" className="inline-block border border-[#C19B6E]/30 text-[#C19B6E] px-8 py-3 text-[9px] uppercase tracking-widest font-bold hover:bg-[#C19B6E] hover:text-[#042D20] rounded-full transition-all duration-500">View on Lombok Perfect</a>
              </div>
            </div>
            ...
            <div className="reveal group bg-[#021811] border border-white/5 rounded-sm overflow-hidden">
              ...
              <div className="p-8 md:p-10">
                ...
                <a href="https://lombokperfect.com" className="inline-block border border-[#C19B6E]/30 text-[#C19B6E] px-8 py-3 text-[9px] uppercase tracking-widest font-bold hover:bg-[#C19B6E] hover:text-[#042D20] rounded-full transition-all duration-500">Explore Options</a>
              </div>
            </div>
            ...
            <div className="reveal group bg-[#021811] border border-white/5 rounded-sm overflow-hidden">
              ...
              <div className="p-8 md:p-10">
                ...
                <a href="https://lombokperfect.com" className="inline-block border border-[#C19B6E]/30 text-[#C19B6E] px-8 py-3 text-[9px] uppercase tracking-widest font-bold hover:bg-[#C19B6E] hover:text-[#042D20] rounded-full transition-all duration-500">View Romance Details</a>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* --- WHY SAIL WITH US --- */}
      <section className="py-20 md:py-32 bg-[#032218] border-b border-[#C19B6E]/10">
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 items-center">
            <div className="reveal">
              <span className="text-[#C19B6E] text-[9px] tracking-[0.8em] uppercase block mb-6 font-bold">Why Choose Lombok Perfect</span>
              <h2 className="font-serif italic text-white text-4xl md:text-6xl leading-[0.95] mb-8">Crafted for <br /><span className="text-[#C19B6E]">the Discerning</span></h2>
              <p className="text-gray-400 text-base leading-relaxed mb-6">
                Every expedition is designed around your preferences, schedule, and curiosities. Our fleet of privately chartered vessels offers the freedom to explore hidden bays, pristine reefs, and remote islands that larger tours simply cannot reach. Whether you seek the thrill of Komodo's ancient dragons, the gentle giants of the deep, or sunset dinners on sandbars in the middle of the ocean, we curate experiences that linger in memory long after the voyage ends.
              </p>
              <p className="text-gray-400 text-base leading-relaxed mb-10">
                Our captains and crew bring decades of local knowledge, ensuring safe passage through the legendary waters of the Flores Sea while revealing the archipelago's best-kept secrets. From the volcanic shores of Lombok to the legendary diving sites of Komodo, each journey is a chapter in Indonesia's most captivating story.
              </p>
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <span className="text-[#C19B6E] text-3xl md:text-4xl font-serif italic block mb-2">15+</span>
                  <span className="text-gray-500 text-xs tracking-wider uppercase">Years of Excellence</span>
                </div>
                <div>
                  <span className="text-[#C19B6E] text-3xl md:text-4xl font-serif italic block mb-2">500+</span>
                  <span className="text-gray-500 text-xs tracking-wider uppercase">Private Expeditions</span>
                </div>
              </div>
            </div>
            <div className="reveal grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="aspect-[3/4] overflow-hidden rounded-sm border border-white/5">
                  <img src="https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop" className="w-full h-full object-cover" alt="Private yacht deck with ocean views" />
                </div>
                <div className="aspect-square overflow-hidden rounded-sm border border-white/5">
                  <img src="https://images.unsplash.com/photo-1569263979104-865ab7cd8d13?auto=format&fit=crop" className="w-full h-full object-cover" alt="Luxury yacht interior" />
                </div>
              </div>
              <div className="space-y-4 pt-8">
                <div className="aspect-square overflow-hidden rounded-sm border border-white/5">
                  <img src="https://images.unsplash.com/photo-1559825481-12a05cc00344?auto=format&fit=crop" className="w-full h-full object-cover" alt="Crystal clear Indonesian waters" />
                </div>
                <div className="aspect-[3/4] overflow-hidden rounded-sm border border-white/5">
                  <img src="https://images.unsplash.com/photo-1516690561799-46d8f74f9abf?auto=format" className="w-full h-full object-cover" alt="Traditional fishing boats in harbor" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-24">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-start">
            <div className="md:col-span-5 reveal">
              ...
              <div className="reveal">
                <a href="https://lombokperfect.com" className="inline-flex items-center gap-4 group">
  ...
  <div className="max-w-7xl mx-auto px-6 md:px-24">
    <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center mb-24">
      ...
      <div className="md:col-span-5 reveal">
        ...
        <div className="reveal">
           <a href="https://lombokperfect.com" 
      ...
      <footer className="bg-[#021811] pt-24 pb-12 px-6 md:px-24 border-t border-[#C19B6E]/10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 text-center md:text-left">
          ...
          <div className="md:col-span-3">
            <h4 className="text-[#C19B6E] text-[9px] uppercase font-bold mb-4 tracking-[0.3em]">Expeditions</h4>
            <ul className="space-y-3">
              <li><a href="https://lombokperfect.com" className="text-white/50 hover:text-[#C19B6E] transition-colors text-sm">Private Charters</a></li>
              <li><a href="https://lombokperfect.com" className="text-white/50 hover:text-[#C19B6E] transition-colors text-sm">Day Sailing</a></li>
              <li><a href="https://lombokperfect.com" className="text-white/50 hover:text-[#C19B6E] transition-colors text-sm">Komodo Tours</a></li>
              <li><a href="https://lombokperfect.com" className="text-white/50 hover:text-[#C19B6E] transition-colors text-sm">Whale Shark Encounters</a></li>
            </ul>
          </div>
          
          <div className="md:col-span-3">
            <h4 className="text-[#C19B6E] text-[9px] uppercase font-bold mb-4 tracking-[0.3em]">Discover</h4>
            <ul className="space-y-3">
              <li><a href="https://lombokperfect.com" className="text-white/50 hover:text-[#C19B6E] transition-colors text-sm">About Us</a></li>
              <li><a href="https://lombokperfect.com" className="text-white/50 hover:text-[#C19B6E] transition-colors text-sm">Gallery</a></li>
              <li><a href="https://lombokperfect.com" className="text-white/50 hover:text-[#C19B6E] transition-colors text-sm">Blog</a></li>
              <li><a href="https://lombokperfect.com" className="text-white/50 hover:text-[#C19B6E] transition-colors text-sm">Contact</a></li>
            </ul>
          </div>
          
          <div className="md:col-span-3 h-[250px] rounded-sm overflow-hidden border border-white/5">
