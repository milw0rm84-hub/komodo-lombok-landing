...
function App() {
  ...
  return (
    <div ref={mainRef} className="bg-[#042D20] text-white selection:bg-[#C19B6E] selection:text-[#042D20] overflow-x-hidden min-h-screen">
      <Helmet>
  <title>Lombok to Komodo Private Trip | Luxury Boat Charter | Lombok Perfect</title>
  <meta name="description" content="Embark on a luxury 4-day private expedition from Lombok to Komodo. Exclusive boat charters, whale shark encounters, and bespoke maritime adventures by Lombok Perfect." />
  <meta name="keywords" content="Lombok Komodo Trip, Private Boat Charter Komodo, Luxury Expedition Indonesia, Whale Shark Tour Sumbawa, Lombok Perfect" />
  
  {/* Open Graph untuk Sosial Media */}
  <meta property="og:title" content="Lombok to Komodo: The Ultimate Private Expedition" />
  <meta property="og:description" content="Discover the hidden gems of Indonesia with Lombok Perfect's luxury maritime atelier." />
  <meta property="og:url" content="https://komodolomboktrip.com" />
